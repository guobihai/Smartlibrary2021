package com.smart.textrunapp.aop;
...
public class ClickLimitAspect {
    ...
    private static final String POINTCUT_ON_ANNOTATION1 = "execution(* android.view.View.OnClickListener.onClick(..))";
    private static final String POINTCUT_ON_ANNOTATION =
            "execution(@com.yxhuang.clicklimit.annotation.ClickLimit * *(..))";

    @Pointcut(POINTCUT_ON_ANNOTATION1)
    ...
    public void processJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        Log.d(TAG, "-----method is click--processJoinPoint- ");
        try {
